...
dependencies {
    ...
    addAppodealMediationAdapters()
}

private fun DependencyHandlerScope.addAppodealMediationAdapters() {
    // Appodeal Dashboard — Configure Mediated Networks (Android, SDK 4.2.0)
