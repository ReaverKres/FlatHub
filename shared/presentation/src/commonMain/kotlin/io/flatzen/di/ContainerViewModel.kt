...
/**
 * ViewModel wrapper for FlowMVI Container.
 * Allows preserving Container across configuration changes.
 * Automatically starts Store on creation.
 *
 * @param container FlowMVI Container for state management
 */
