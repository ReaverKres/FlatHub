...
object LivoFlatMapper {
    ...
    private fun mapItem(
        ...
        return AppFlat(
            ...
            imageUrls = images,
            mainPrice = priceGel ?: base?.mainPrice,
            secondPrice = priceUsd ?: base?.secondPrice,
            mainPriceSquare = priceGelSq ?: base?.mainPriceSquare,
            secondPriceSquare = priceUsdSq ?: base?.secondPriceSquare,
